...
# Script for calculating dxy inside inverted region between quails with and without the inversion.
...
open IN, "quail_inversion_snps.recode.vcf" or die;

open OUT, ">>quail_inversion_dxy.txt" or die;
...
my $inversion_length = 116510000; # Length of the region covered by the inversion in the vcf file
...
print "Average dxy between inverted and non-inverted samples across inversion region = $average_dxy\n";
